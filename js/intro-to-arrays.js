...
//
// arr1.push(6); // returns 5 since a last e;ement of length
//
// var arr2 = ['a', 'b', 'c'];
//
// var arr3 = [6, 'd', 7, 'e']
...
// colors.length starts at 1 counts numbers of elements in an array
// colors.length used to find last index in an array
//colors.length
...
var favoriteFoods = ['ramen', 'shumai dumplings', 'laksa soup'];
...
for (var i = 0; i < shapes.length; i++) {
    ...
    if (shapes[i] === 'circle') {
        ...
        break; // stops at circle does not continue
    }
}
// TODO: What happens if we change var i = 1? or var i = 2;
// TODO: What are benefits of using loops to iterate? // allows use to stop repeating code
// TODO: How does the loop know when to stop iterating?  // when it reaches last index it stops
