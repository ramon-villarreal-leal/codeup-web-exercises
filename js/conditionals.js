...
function analyzeColorSwitch(color) {
    ...
    switch (color) {
        case "red":
            ...
            break;
        case "yellow":
            return "Yellow like Bananas go bananas!";
            break;
        case "orange":
            return "Orange like oranges! Who would have known!";
            break;
        case "green":
            return "Green like Spinach";
            break;
        case "blue":
            return "blue is the color of the sky";
            break;
        case "indigo":
            return "indigo like my shirt";
            break;
        case "violet":
            return "violet like a flower that is not my shirt";
            break;
    }
}
...
console.log("This is for number 1: $" + calculateTotal(1, 60));
console.log("This of for number 2: $" + calculateTotal(2, 60));
console.log("This is for number 3: $" + calculateTotal(3, 60));
console.log("This is for number 4: $" + calculateTotal(4, 60));
